...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const command_1 = __nccwpck_require__(4137);
const file_command_1 = __nccwpck_require__(1693);
const utils_1 = __nccwpck_require__(3400);
const os = __importStar(__nccwpck_require__(2087));
...
const axios_1 = __importDefault(__nccwpck_require__(4222));
const errors_1 = __nccwpck_require__(451);
const instrument_1 = __nccwpck_require__(5042);
/**
...
module.exports = __nccwpck_require__(5155);
...
var utils = __nccwpck_require__(2651);
var settle = __nccwpck_require__(1476);
var buildFullPath = __nccwpck_require__(8392);
var buildURL = __nccwpck_require__(9418);
var http = __nccwpck_require__(8605);
var https = __nccwpck_require__(7211);
var httpFollow = __nccwpck_require__(5082).http;
var httpsFollow = __nccwpck_require__(5082).https;
var url = __nccwpck_require__(8835);
var zlib = __nccwpck_require__(8761);
var pkg = __nccwpck_require__(696);
var createError = __nccwpck_require__(8730);
var enhanceError = __nccwpck_require__(5762);
...
var utils = __nccwpck_require__(2651);
var settle = __nccwpck_require__(1476);
var cookies = __nccwpck_require__(3587);
var buildURL = __nccwpck_require__(9418);
var buildFullPath = __nccwpck_require__(8392);
var parseHeaders = __nccwpck_require__(2872);
var isURLSameOrigin = __nccwpck_require__(2529);
var createError = __nccwpck_require__(8730);
...
var utils = __nccwpck_require__(2651);
var bind = __nccwpck_require__(931);
var Axios = __nccwpck_require__(9225);
var mergeConfig = __nccwpck_require__(8189);
var defaults = __nccwpck_require__(1275);
...
axios.Cancel = __nccwpck_require__(8521);
axios.CancelToken = __nccwpck_require__(9965);
axios.isCancel = __nccwpck_require__(1935);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __nccwpck_require__(1117);

// Expose isAxiosError
axios.isAxiosError = __nccwpck_require__(2814);
...
var Cancel = __nccwpck_require__(8521);
...
var utils = __nccwpck_require__(2651);
var buildURL = __nccwpck_require__(9418);
var InterceptorManager = __nccwpck_require__(3401);
var dispatchRequest = __nccwpck_require__(1630);
var mergeConfig = __nccwpck_require__(8189);
...
var isAbsoluteURL = __nccwpck_require__(6724);
var combineURLs = __nccwpck_require__(6961);
...
var utils = __nccwpck_require__(2651);
var transformData = __nccwpck_require__(8675);
var isCancel = __nccwpck_require__(1935);
var defaults = __nccwpck_require__(1275);
...
var utils = __nccwpck_require__(2651);
var normalizeHeaderName = __nccwpck_require__(5002);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __nccwpck_require__(3303);
  } else if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    // For node use HTTP adapter
    adapter = __nccwpck_require__(8145);
  }
  return adapter;
}
...
module.exports = __nccwpck_require__(3840)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __nccwpck_require__(4174);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __nccwpck_require__(9506);
} else {
	module.exports = __nccwpck_require__(6919);
}
...
try {
	...
	const supportsColor = __nccwpck_require__(717);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(2140)("follow-redirects");
    }
    catch (error) {
      debug = function () { /* */ };
    }
...
var debug = __nccwpck_require__(8306);
...
const hasFlag = __nccwpck_require__(5028);
...
exports.readEnvVariables = () => {
    ...
    if (!webhookURL) {
        throw Error(`Env variable SLACK_WEBHOOK_URL not found. Please specify this variable.`);
    }
    ...
    return {
        ...
        attachmentsTitle: (_a = process.env.TITLE, (_a !== null && _a !== void 0 ? _a : '')),
        attachmentsTitleURL: (_b = process.env.TITLE_URL, (_b !== null && _b !== void 0 ? _b : '')),
        attachmentsBody: (_c = process.env.BODY, (_c !== null && _c !== void 0 ? _c : '')),
        attachmentsColor: (_d = process.env.COLOR, (_d !== null && _d !== void 0 ? _d : 'green')),
        attachmentsMrkdn: (_e = process.env.USE_MARKDOWN, (_e !== null && _e !== void 0 ? _e : 'true'))
    };
};
...
const slack = __importStar(__nccwpck_require__(3461));
const utils_1 = __nccwpck_require__(5018);
const env_variables_1 = __nccwpck_require__(627);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const { webhookURL, githubActor, githubRef, githubEvent, slackIconURL, slackGithubPairs, slackUsername, attachmentsTitle, attachmentsTitleURL, attachmentsBody, attachmentsColor, attachmentsMrkdn } = env_variables_1.readEnvVariables();
        const title = utils_1.replaceGitHubUsernameWithSlackUsername((attachmentsTitle !== null && attachmentsTitle !== void 0 ? attachmentsTitle : ''), (slackGithubPairs !== null && slackGithubPairs !== void 0 ? slackGithubPairs : ''));
        const body = utils_1.replaceGitHubUsernameWithSlackUsername((attachmentsBody !== null && attachmentsBody !== void 0 ? attachmentsBody : ''), (slackGithubPairs !== null && slackGithubPairs !== void 0 ? slackGithubPairs : ''));
        const webhook = new slack.IncomingWebhook(webhookURL);
        const attachments = utils_1.createAttachment({
        ...
        const args = utils_1.createIncomingWebhookSendArguments({
...
exports.createIncomingWebhookSendArguments = (args) => {
    return {
...
exports.replaceGitHubUsernameWithSlackUsername = (text, usernames) => {
    var _a;
    const githubToSlack = (_a = usernames.replace(/\r/g, '\n')
        .split('\n')
        .reduce((result, row) => {
...
/******/ 	return __nccwpck_require__(741);
/******/ })()
;